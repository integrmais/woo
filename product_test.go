...
func TestListProducts(t *testing.T) {
	...
	serviceUrl := fmt.Sprintf("/wp-json/wc/%s/products", versionMock)
	...
	if !strings.EqualFold(expectedUri, serviceUrl) {
		t.Fatalf("Expected correct service url %s, got %s", serviceUrl, expectedUri)
	}
